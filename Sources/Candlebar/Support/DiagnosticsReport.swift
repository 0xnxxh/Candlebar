...
struct DiagnosticsReport {
    ...
    var redactedText: String {
        [
            ...
            "Header Intraday Interval: \(preferences.headerIntradayInterval.rawValue)",
            "Header Chart Display: \(preferences.headerChartDisplayMode.rawValue)",
            "Watchlist Intraday Interval: \(preferences.watchlistIntradayInterval.rawValue)",
            "",
            "Watchlist:",
            watchlistText,
            "",
